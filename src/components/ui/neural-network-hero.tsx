...
function ShaderPlane() {
  ...
  useFrame((state) => {
    ...
    // Scale plane to fill viewport based on aspect ratio
    const aspect = width / height;
    const scaleX = aspect > 1 ? aspect * 1.2 : 1.2; // Wider for landscape
    const scaleY = aspect < 1 ? (1 / aspect) * 1.2 : 1.2; // Taller for portrait
